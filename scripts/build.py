...
def render_domains(domains: list[str]) -> str:
    header = [
        "# OSFilter plain domains",
        "# One domain per line. Generated; do not edit directly.",
        "# Data-License: ODbL-1.0",
        "",
    ]
    return "\n".join(header + domains).rstrip() + "\n"
...
def main() -> None:
    ...
    write(ROOT / "domains.txt", render_domains(full_domains))
    ...
    stats = {
        ...
        "gambling": len(categories["Bahis/Kumar"]),
        "allowlist": len(allow),
    }
